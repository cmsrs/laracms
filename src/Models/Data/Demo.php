...
class Demo
{
    ...
    public function pagesAndMenu($unitTest = false)
    {
        ...
        [
            ...
            <div class='row'>
              <div class='col-md-4'>
                <h3>".(new Page)->getPageDataByShortTitleCache( 'main_page_box1', 'title', 'en' )."</h3>
                <p>
                  ".(new Page)->getPageDataByShortTitleCache( 'main_page_box1', 'content', 'en' )."
                </p>
              </div>
              <div class='col-md-4'>
                <h3>".(new Page)->getPageDataByShortTitleCache( 'main_page_box2', 'title', 'en'  )."</h3>
                <p>
                  ".(new Page)->getPageDataByShortTitleCache( 'main_page_box2', 'content', 'en'  )."
                </p>
              </div>
              <div class='col-md-4'>
                <h3>".(new Page)->getPageDataByShortTitleCache( 'main_page_box3', 'title', 'en'  )."</h3>
                <p>
                  ".(new Page)->getPageDataByShortTitleCache( 'main_page_box3', 'content', 'en'  )."
                </p>
              </div>
            </div>
            ...
            <div class='row'>
              <div class='col-md-4'>
                <h3>".(new Page)->getPageDataByShortTitleCache( 'main_page_box1', 'title', 'pl'  )."</h3>
                <p>
                  ".(new Page)->getPageDataByShortTitleCache( 'main_page_box1', 'content', 'pl' )."
                </p>
              </div>
              <div class='col-md-4'>
                <h3>".(new Page)->getPageDataByShortTitleCache( 'main_page_box2', 'title', 'pl' )."</h3>
                <p>
                  ".(new Page)->getPageDataByShortTitleCache( 'main_page_box2', 'content', 'pl' )."
                </p>
              </div>
              <div class='col-md-4'>
                <h3>".(new Page)->getPageDataByShortTitleCache( 'main_page_box3', 'title', 'pl' )."</h3>
                <p>
                  ".(new Page)->getPageDataByShortTitleCache( 'main_page_box3', 'content', 'pl' )."
                </p>
              </div>
            </div>
