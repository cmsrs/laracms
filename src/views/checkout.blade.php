        ...
        <div class="col-sm-4">   
          ...
          <div class="mt-5">        
            ...
            @foreach ($payments as $key_payment => $payment)
              <div class="form-check">
                <input class="form-check-input" type="radio" name="payment" id="{{ $key_payment }}" value="{{ $key_payment }}"  @if(old("payment") == $key_payment ) checked @endif  @if( ($key_payment === \Cmsrs\Laracms\Models\Payment::KEY_PAYU) && ( env('DEMO_STATUS') ) ) disabled @endif >
